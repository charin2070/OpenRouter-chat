      ...
      <Card className="w-full max-w-md bg-gray-800 border-gray-700">
        ...
        <CardContent className="space-y-4">
          <Button
            ...
            disabled={isLoading}
            className="w-full bg-white text-gray-900 hover:bg-gray-100 border border-gray-300 flex items-center justify-center gap-3 py-3 px-4 rounded-lg font-medium transition-colors"
          >
